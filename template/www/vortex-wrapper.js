...
PINF.bundle("", function(require) {
  ...
  require.memoize("/vortex-wrapper.js",  function(require, exports, module) {
    ...
    exports.main = function (options) {
      ...
      function log (label, obj) {
          ...
          console.log(args.label, args.obj);
      }
      ...
      API.console.log("[pinf-hoist] load rootVortexUrl: " + options.rootVortexUrl, options.rootVortexUrl);

      require.sandbox(options.rootVortexUrl, {
        debug: DEBUG,
        global: {
...
//        monitorComponentServer(config);
        ...
        API.console.log("[pinf-hoist] call main using API", API);
        ...
        */
        ...
        return API.Q.when((api.resolve && api.resolve(resolver, config, previousResolvedSectionConfig)) || defaultResolve(resolver, config, previousResolvedSectionConfig)).then(function (resolvedSectionConfig) {
          ...
          API.insight.error("Fail resolve/turn/spin", err.stack);

        });

      }, function (err) {

        API.insight.error("Error loading root vortex url", err.stack);
      });
    }
  }, {});

  require.memoize("/q.js",  function(require, exports, module) {
